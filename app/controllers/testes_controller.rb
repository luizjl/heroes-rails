class TestesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @testis.save
        format.html { redirect_to testis_url(@testis), notice: "Teste was successfully created." }
  ...
  def update
    respond_to do |format|
      if @testis.update(testis_params)
        format.html { redirect_to testis_url(@testis), notice: "Teste was successfully updated." }
